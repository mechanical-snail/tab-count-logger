...
const initDB = function initDB() {
	...
	sqlite.execute("CREATE TABLE IF NOT EXISTS tabCountLog(timestamp TEXT PRIMARY KEY, windows INTEGER, tabs INTEGER);", {}, function(){console.log("Finished initializing database");});
}
initDB();
